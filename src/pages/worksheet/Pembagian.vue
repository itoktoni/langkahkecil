<template>
  <div class="ws-wrapper">
    <div class="ws-toolbar">
      ...
      <div class="ws-toolbar-title"><Icon icon="mdi:division" class="ws-toolbar-icon" /> Pembagian 1-10</div>
    ...
    <div ref="printArea" class="ws-print-area">
        <div class="ws-header">
          <div class="ws-header-box title-box">
            <span class="ws-title"><Icon icon="mdi:division" class="ws-title-icon" /> Pembagian 1-10</span>
          </div>
...
async function downloadPDF() {
  ...
  try {
    ...
    await downloadWorksheetPDF(printArea.value, 'Worksheet_Pembagian_1-10.pdf')
  } catch (e) {
    console.error(e)
