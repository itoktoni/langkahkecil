<template>
  <div class="ws-wrapper">
    <div class="ws-toolbar">
      ...
      <div class="ws-toolbar-title"><Icon icon="mdi:pencil-outline" class="ws-toolbar-icon" /> Menebalkan Angka</div>
    ...
    <div ref="printArea" class="ws-print-area">
      <div class="ws-header">
        <div class="ws-header-box title-box">
          <span class="ws-title">Menebalkan Angka</span>
        </div>
...
async function downloadPDF() {
  ...
  try {
    ...
    await downloadWorksheetPDF(printArea.value, 'Worksheet_MenebalkanAngka_1-10.pdf')
  } catch (e) {
    console.error(e)
